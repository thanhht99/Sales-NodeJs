    ...
    if (cart) {
        ...
        if (!product) {
            ...
            if (product.isPromotion) {
                const promotion = await Promotion.findOne({ productId, isActive: true });
            ...
            cart.products[indexFound].total =
                (cart.products[indexFound].quantity * product.price) - (cart.products[indexFound].quantity * product.price * cart.products[indexFound].promotion);
            ...
            cart.products.push({
                ...
                total: parseInt(product.price * quantity) - parseInt(product.price * promotionProduct * quantity),
                price: product.price,
            });
        } else {
